<template>
  <div class="fixed top-0 w-screen h-screen">
    <form class="flex justify-center items-center w-full z-[999] w-screen h-screen" @submit.prevent="submit">
      <div
      ...
      />
      <div
          class="relative lg:w-1/2 sm:w-3/4 w-[90%] m-auto absolute left-0 sm:p-10 p-6 bg-white rounded-3xl z-20 max-w-[600px]">
        <button
